# AGENTS.md — chapter-publishing/chapter-publishing-mcp-server.rs
...
- GitHub org: [`chapter-publishing`](https://github.com/chapter-publishing)
- Repository: [`chapter-publishing/chapter-publishing-mcp-server.rs`](https://github.com/chapter-publishing/chapter-publishing-mcp-server.rs)
- Local checkout: `~/codes/chapter-publishing/chapter-publishing-mcp-server.rs`
- Linear project: https://linear.app/denman/project/githubcomchapter-publishing-6fe9d785342c
- GitHub org project: https://github.com/orgs/chapter-publishing/projects/1
- Sibling test org: `github.com/chapter-publishing-test` (external/e2e coverage and extra GHA minutes)
...
- Package / service name: `chapter-publishing-mcp-server`
