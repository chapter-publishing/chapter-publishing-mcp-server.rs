...
final class McpEnvValues {
  const McpEnvValues({required this.chapterPublishingMcpServerBind});

  final String chapterPublishingMcpServerBind;
}

/// Pure: resolve values from an explicit lookup.
McpEnvValues loadFrom(String? Function(String key) lookup) {
  return McpEnvValues(
    chapterPublishingMcpServerBind: _nonEmpty(lookup('CHAPTER_PUBLISHING_MCP_SERVER_BIND')) ?? '127.0.0.1:9090',
  );
}
...
Map<String, String> loadEnvMap(
  ...
  final out = <String, String>{};
  final chapterPublishingMcpServerBind = pick(['CHAPTER_PUBLISHING_MCP_SERVER_BIND'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, '127.0.0.1:9090');
  if (chapterPublishingMcpServerBind != null) out['CHAPTER_PUBLISHING_MCP_SERVER_BIND'] = chapterPublishingMcpServerBind;
  return out;
}
